...
type FileList struct {
	...
	Files []*FileR `protobuf:"bytes,1,rep,name=files,proto3" json:"files,omitempty"`
}
...
func (x *FileList) GetFiles() []*FileR {
	if x != nil {
		return x.Files
	}
	return nil
...
var file_file_proto_rawDesc = []byte{
	...
	0x0a, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x52, 0x52, 0x05, 0x66, 0x69, 0x6c,
	0x65, 0x73, 0x2a, 0x20, 0x0a, 0x09, 0x46, 0x69, 0x6c, 0x65, 0x54, 0x79, 0x70, 0x65, 0x45, 0x12,
...
var file_file_proto_depIdxs = []int32{
	...
	1, // 3: api.FileList.files:type_name -> api.FileR
