...
const FileList$json = const {
  '1': 'FileList',
  '2': const [
    const {'1': 'files', '3': 1, '4': 3, '5': 11, '6': '.api.FileR', '10': 'files'},
  ],
};

/// Descriptor for `FileList`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List fileListDescriptor = $convert.base64Decode('CghGaWxlTGlzdBIgCgVmaWxlcxgBIAMoCzIKLmFwaS5GaWxlUlIFZmlsZXM=');
