...
const UserListR$json = const {
  '1': 'UserListR',
  '2': const [
    const {'1': 'list', '3': 1, '4': 3, '5': 11, '6': '.api.UserItemR', '10': 'list'},
    const {'1': 'total', '3': 2, '4': 1, '5': 3, '10': 'total'},
  ],
};

/// Descriptor for `UserListR`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List userListRDescriptor = $convert.base64Decode('CglVc2VyTGlzdFISIgoEbGlzdBgBIAMoCzIOLmFwaS5Vc2VySXRlbVJSBGxpc3QSFAoFdG90YWwYAiABKANSBXRvdGFs');
